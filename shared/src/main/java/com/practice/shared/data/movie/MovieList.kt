...
import com.practice.shared.domain.movie.Movie as DomainMovie
...
data class MovieList(
    ...
    private fun convertResultsGroup(list: List<Movie?>?): List<DomainMovie> {
        return com.practice.shared.common.DataMapperUtil.convertToNonNull(list).map { it.convertToDomain() }
    }
}
...
data class Movie(
    ...
    fun convertToDomain(): DomainMovie {
        return DomainMovie(
            ...
            genreIds = com.practice.shared.common.DataMapperUtil.convertToNonNull(this.genreIds),
            id = this.id ?: 0,
